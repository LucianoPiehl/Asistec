...
-- Tiempo de generación: 27-12-2021 a las 10:56:22
...
(8, 'Piehl', 'Luciano', 45558607, '2003-04-13', 1212121212, 'download.jpg', 'luchopinamar123@gmail.com', 'hombre', '2021');
...
--
-- Volcado de datos para la tabla `habilitadoscomedor`
--

INSERT INTO `habilitadoscomedor` (`idalumno`, `nrodiasemana`) VALUES
(2, 3);
...
--
-- Volcado de datos para la tabla `habilitadostemporalmente`
--

INSERT INTO `habilitadostemporalmente` (`idalumno`, `fechacomedor`, `idusuario`) VALUES
(2, '2021-12-06', 'BG');
...
CREATE TABLE `horarios` (
  ...
  `idcurso` int(111) NOT NULL,
  `numerodiasemana` int(11) NOT NULL,
  `idmateria` int(111) NOT NULL,
  `idprofesor` int(111) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `horarios` (`idhorario`, `idturno`, `horainicio`, `horafin`, `idcurso`, `numerodiasemana`, `idmateria`, `idprofesor`) VALUES
(3, 2, '03:33:00', '04:44:00', 2, 6, 1, 2);
...
CREATE TABLE `materias` (
  `idmateria` int(111) NOT NULL,
  `nombremateria` varchar(111) NOT NULL,
  `idcurso` int(111) NOT NULL,
  `nrogrupo` int(111) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `materias` (`idmateria`, `nombremateria`, `idcurso`, `nrogrupo`) VALUES
(21, 'Programacion', 25, 1),
(22, 'Hardware', 25, 1),
(23, 'Sistemas Operativos', 25, 1),
(24, 'Base de datos', 25, 1);
...
CREATE TABLE `profesores` (
  ...
  `numero_tarjeta` int(111) NOT NULL,
...
INSERT INTO `profesores` (`id`, `DNI`, `nombre`, `apellido`, `telefono`, `mail`, `numero_tarjeta`, `nombre_imagen`) VALUES
(1, 213321, 'Luciano', 'Piehl', 2147483647, 'luchopinamar123@gmail.com', 2132132145, ''),
(2, 21312312, 'Angel', 'Correa', 2147483647, 'luchopinamar123@gmail.com', 2132132145, '');
...
INSERT INTO `sessions` (`idsession`, `idusuario`, `fecha`, `hora`, `idperfil`, `apenom`) VALUES
(1280178947, 'MS', '2021-12-06', '01:58:20', 2, 'SOTO, MATEO'),
(5075128582, 'BG', '2021-12-06', '05:54:13', 2, 'ROBERTO, BOGGIO');
...
--
ALTER TABLE `materias`
  MODIFY `idmateria` int(111) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
ALTER TABLE `alumnosxmaterias`
  ...
  ADD CONSTRAINT `materiasxalumnos` FOREIGN KEY (`idmateria`) REFERENCES `materias` (`idmateria`);
...
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`idturno`) REFERENCES `turnos` (`idturno`);
...
ALTER TABLE `notas`
  ...
  ADD CONSTRAINT `materiasxnotas` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`idmateria`),
...
--
ALTER TABLE `usuariosxmaterias`
  ADD CONSTRAINT `materias` FOREIGN KEY (`idmateria`) REFERENCES `materias` (`idmateria`) ON DELETE CASCADE ON UPDATE CASCADE,
